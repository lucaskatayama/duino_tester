...
// switch to 1.1V Reference
  ...
  while (Samples < ADCconfig.Samples)
  {                 // take samples
    StartADCwait(); // start ADC and wait
...
#if F_CPU == 16000000UL
#define DelayBigCap()                                                        \
  us500delay(18); /* 2.5 ADC clocks = 20us */                                \
...
#if F_CPU == 16000000UL
#define DelaySmallCap()                                                      \
  us500delay(3); /* with only 18 us delay the voltage goes down before SH */ \
...
#if F_CPU == 16000000UL
#define DelaySmallCap()                                                             \
  us500delay(4); /* with only 4 us delay the voltage goes down before SH */         \
